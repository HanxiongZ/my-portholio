...
}`,ap=[new N(1,0,0),new N(-1,0,0),new N(0,1,0),new N(0,-1,0),new N(0,0,1),new N(0,0,-1)],op=[new N(0,-1,0),new N(0,-1,0),new N(0,0,1),new N(0,0,-1),new N(0,-1,0),new N(0,-1,0)],go=new rt,Si=new N,is=new N;function lp(i,e,t){let n=new Vo;const r=new Xe,s=new Xe,a=new ot,o=new Tc,c=new yc,l={},f=t.maxTextureSize,m={[An]:At,[At]:An,[ln]:ln},u=new Qt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Xe},radius:{value:4}},vertexShader:rp,fragmentShader:sp}),d=u.clone();d.defines.HORIZONTAL_PASS=1;const _=new wt;_.setAttribute("position",new jt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new Lt(_,u),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=sr;let h=this.type;this.render=function(A,P,x){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||A.length===0)return;this.type===ul&&(we("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=sr);const E=i.getRenderTarget(),W=i.getActiveCubeFace(),R=i.getActiveMipmapLevel(),U=i.state;U.setBlending(un),U.buffers.depth.getReversed()===!0?U.buffers.color.setClear(0,0,0,0):U.buffers.color.setClear(1,1,1,1),U.buffers.depth.setTest(!0),U.setScissorTest(!1);const F=h!==this.type;F&&P.traverse(function(z){z.material&&(Array.isArray(z.material)?z.material.forEach(G=>G.needsUpdate=!0):z.material.needsUpdate=!0)});for(let z=0,G=A.length;z<G;z++){const B=A[z],H=B.shadow;if(H===void 0){we("WebGLShadowMap:",B,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;r.copy(H.mapSize);const Q=H.getFrameExtents();r.multiply(Q),s.copy(H.mapSize),(r.x>f||r.y>f)&&(r.x>f&&(s.x=Math.floor(f/Q.x),r.x=s.x*Q.x,H.mapSize.x=s.x),r.y>f&&(s.y=Math.floor(f/Q.y),r.y=s.y*Q.y,H.mapSize.y=s.y));const $=i.state.buffers.depth.getReversed();if(H.camera._reversedDepth=$,H.map===null||F===!0){if(H.map!==null&&(H.map.depthTexture!==null&&(H.map.depthTexture.dispose(),H.map.depthTexture=null),H.map.dispose()),this.type===Ei){if(B.isPointLight){we("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}H.map=new $t(r.x,r.y,{format:li,type:fn,minFilter:Mt,magFilter:Mt,generateMipmaps:!1}),H.map.texture.name=B.name+".shadowMap",H.map.depthTexture=new Ri(r.x,r.y,Yt),H.map.depthTexture.name=B.name+".shadowMapDepth",H.map.depthTexture.format=dn,H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=gt,H.map.depthTexture.magFilter=gt}else B.isPointLight?(H.map=new Zo(r.x),H.map.depthTexture=new gc(r.x,Jt)):(H.map=new $t(r.x,r.y),H.map.depthTexture=new Ri(r.x,r.y,Jt)),H.map.depthTexture.name=B.name+".shadowMap",H.map.depthTexture.format=dn,this.type===sr?(H.map.depthTexture.compareFunction=$?ra:ia,H.map.depthTexture.minFilter=Mt,H.map.depthTexture.magFilter=Mt):(H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=gt,H.map.depthTexture.magFilter=gt);H.camera.updateProjectionMatrix()}const he=H.map.isWebGLCubeRenderTarget?6:1;for(let oe=0;oe<he;oe++){if(H.map.isWebGLCubeRenderTarget)i.setRenderTarget(H.map,oe),i.clear();else{oe===0&&(i.setRenderTarget(H.map),i.clear());const se=H.getViewport(oe);a.set(s.x*se.x,s.y*se.y,s.x*se.z,s.y*se.w),U.viewport(a)}if(B.isPointLight){const se=H.camera,be=H.matrix,ze=B.distance||se.far;ze!==se.far&&(se.far=ze,se.updateProjectionMatrix()),Si.setFromMatrixPosition(B.matrixWorld),se.position.copy(Si),is.copy(se.position),is.add(ap[oe]),se.up.copy(op[oe]),se.lookAt(is),se.updateMatrixWorld(),be.makeTranslation(-Si.x,-Si.y,-Si.z),go.multiplyMatrices(se.projectionMatrix,se.matrixWorldInverse),H._frustum.setFromProjectionMatrix(go,se.coordinateSystem,se.reversedDepth)}else H.updateMatrices(B);n=H.getFrustum(),y(P,x,H.camera,B,this.type)}H.isPointLightShadow!==!0&&this.type===Ei&&S(H,x),H.needsUpdate=!1}h=this.type,p.needsUpdate=!1,i.setRenderTarget(E,W,R)};function S(A,P){const x=e.update(M);u.defines.VSM_SAMPLES!==A.blurSamples&&(u.defines.VSM_SAMPLES=A.blurSamples,d.defines.VSM_SAMPLES=A.blurSamples,u.needsUpdate=!0,d.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new $t(r.x,r.y,{format:li,type:fn})),u.uniforms.shadow_pass.value=A.map.depthTexture,u.uniforms.resolution.value=A.mapSize,u.uniforms.radius.value=A.radius,i.setRenderTarget(A.mapPass),i.clear(),i.renderBufferDirect(P,null,x,u,M,null),d.uniforms.shadow_pass.value=A.mapPass.texture,d.uniforms.resolution.value=A.mapSize,d.uniforms.radius.value=A.radius,i.setRenderTarget(A.map),i.clear(),i.renderBufferDirect(P,null,x,d,M,null)}function b(A,P,x,E){let W=null;const R=x.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(R!==void 0)W=R;else if(W=x.isPointLight===!0?c:o,i.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0||P.alphaToCoverage===!0){const U=W.uuid,F=P.uuid;let z=l[U];z===void 0&&(z={},l[U]=z);let G=z[F];G===void 0&&(G=W.clone(),z[F]=G,P.addEventListener("dispose",w)),W=G}if(W.visible=P.visible,W.wireframe=P.wireframe,E===Ei?W.side=P.shadowSide!==null?P.shadowSide:P.side:W.side=P.shadowSide!==null?P.shadowSide:m[P.side],W.alphaMap=P.alphaMap,W.alphaTest=P.alphaToCoverage===!0?.5:P.alphaTest,W.map=P.map,W.clipShadows=P.clipShadows,W.clippingPlanes=P.clippingPlanes,W.clipIntersection=P.clipIntersection,W.displacementMap=P.displacementMap,W.displacementScale=P.displacementScale,W.displacementBias=P.displacementBias,W.wireframeLinewidth=P.wireframeLinewidth,W.linewidth=P.linewidth,x.isPointLight===!0&&W.isMeshDistanceMaterial===!0){const U=i.properties.get(W);U.light=x}return W}function y(A,P,x,E,W){if(A.visible===!1)return;if(A.layers.test(P.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&W===Ei)&&(!A.frustumCulled||n.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,A.matrixWorld);const F=e.update(A),z=A.material;if(Array.isArray(z)){const G=F.groups;for(let B=0,H=G.length;B<H;B++){const Q=G[B],$=z[Q.materialIndex];if($&&$.visible){const he=b(A,$,E,W);A.onBeforeShadow(i,A,P,x,F,he,Q),i.renderBufferDirect(x,null,F,he,A,Q),A.onAfterShadow(i,A,P,x,F,he,Q)}}}else if(z.visible){const G=b(A,z,E,W);A.onBeforeShadow(i,A,P,x,F,G,null),i.renderBufferDirect(x,null,F,G,A,null),A.onAfterShadow(i,A,P,x,F,G,null)}}const U=A.children;for(let F=0,z=U.length;F<z;F++)y(U[F],P,x,E,W)}function w(A){A.target.removeEventListener("dispose",w);for(const x in l){const E=l[x],W=A.target.uuid;W in E&&(E[W].dispose(),delete E[W])}}}function cp(i,e){function t(){let D=!1;const re=new ot;let te=null;const pe=new ot(0,0,0,0);return{setMask:function(J){te!==J&&!D&&(i.colorMask(J,J,J,J),te=J)},setLocked:function(J){D=J},setClear:function(J,X,_e,Pe,nt){nt===!0&&(J*=Pe,X*=Pe,_e*=Pe),re.set(J,X,_e,Pe),pe.equals(re)===!1&&(i.clearColor(J,X,_e,Pe),pe.copy(re))},reset:function(){D=!1,te=null,pe.set(-1,0,0,0)}}}function n(){let D=!1,re=!1,te=null,pe=null,J=null;return{setReversed:function(X){if(re!==X){const _e=e.get("EXT_clip_control");X?_e.clipControlEXT(_e.LOWER_LEFT_EXT,_e.ZERO_TO_ONE_EXT):_e.clipControlEXT(_e.LOWER_LEFT_EXT,_e.NEGATIVE_ONE_TO_ONE_EXT),re=X;const Pe=J;J=null,this.setClear(Pe)}},getReversed:function(){return re},setTest:function(X){X?ne(i.DEPTH_TEST):ae(i.DEPTH_TEST)},setMask:function(X){te!==X&&!D&&(i.depthMask(X),te=X)},setFunc:function(X){if(re&&(X=Wl[X]),pe!==X){switch(X){case as:i.depthFunc(i.NEVER);break;case os:i.depthFunc(i.ALWAYS);break;case ls:i.depthFunc(i.LESS);break;case ai:i.depthFunc(i.LEQUAL);break;case cs:i.depthFunc(i.EQUAL);break;case us:i.depthFunc(i.GEQUAL);break;case hs:i.depthFunc(i.GREATER);break;case fs:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}pe=X}},setLocked:function(X){D=X},setClear:function(X){J!==X&&(J=X,re&&(X=1-X),i.clearDepth(X))},reset:function(){D=!1,te=null,pe=null,J=null,re=!1}}}function r(){let D=!1,re=null,te=null,pe=null,J=null,X=null,_e=null,Pe=null,nt=null;return{setTest:function(Ze){D||(Ze?ne(i.STENCIL_TEST):ae(i.STENCIL_TEST))},setMask:function(Ze){re!==Ze&&!D&&(i.stencilMask(Ze),re=Ze)},setFunc:function(Ze,en,tn){(te!==Ze||pe!==en||J!==tn)&&(i.stencilFunc(Ze,en,tn),te=Ze,pe=en,J=tn)},setOp:function(Ze,en,tn){(X!==Ze||_e!==en||Pe!==tn)&&(i.stencilOp(Ze,en,tn),X=Ze,_e=en,Pe=tn)},setLocked:function(Ze){D=Ze},setClear:function(Ze){nt!==Ze&&(i.clearStencil(Ze),nt=Ze)},reset:function(){D=!1,re=null,te=null,pe=null,J=null,X=null,_e=null,Pe=null,nt=null}}}const s=new t,a=new n,o=new r,c=new WeakMap,l=new WeakMap;let f={},m={},u=new WeakMap,d=[],_=null,M=!1,p=null,h=null,S=null,b=null,y=null,w=null,A=null,P=new Ye(0,0,0),x=0,E=!1,W=null,R=null,U=null,F=null,z=null;const G=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let B=!1,H=0;const Q=i.getParameter(i.VERSION);Q.indexOf("WebGL")!==-1?(H=parseFloat(/^WebGL (\d)/.exec(Q)[1]),B=H>=1):Q.indexOf("OpenGL ES")!==-1&&(H=parseFloat(/^OpenGL ES (\d)/.exec(Q)[1]),B=H>=2);let $=null,he={};const oe=i.getParameter(i.SCISSOR_BOX),se=i.getParameter(i.VIEWPORT),be=new ot().fromArray(oe),ze=new ot().fromArray(se);function Ve(D,re,te,pe){const J=new Uint8Array(4),X=i.createTexture();i.bindTexture(D,X),i.texParameteri(D,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(D,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let _e=0;_e<te;_e++)D===i.TEXTURE_3D||D===i.TEXTURE_2D_ARRAY?i.texImage3D(re,0,i.RGBA,1,1,pe,0,i.RGBA,i.UNSIGNED_BYTE,J):i.texImage2D(re+_e,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,J);return X}const q={};q[i.TEXTURE_2D]=Ve(i.TEXTURE_2D,i.TEXTURE_2D,1),q[i.TEXTURE_CUBE_MAP]=Ve(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),q[i.TEXTURE_2D_ARRAY]=Ve(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),q[i.TEXTURE_3D]=Ve(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ne(i.DEPTH_TEST),a.setFunc(ai),Ne(!1),st(xa),ne(i.CULL_FACE),Ke(un);function ne(D){f[D]!==!0&&(i.enable(D),f[D]=!0)}function ae(D){f[D]!==!1&&(i.disable(D),f[D]=!1)}function Le(D,re){return m[D]!==re?(i.bindFramebuffer(D,re),m[D]=re,D===i.DRAW_FRAMEBUFFER&&(m[i.FRAMEBUFFER]=re),D===i.FRAMEBUFFER&&(m[i.DRAW_FRAMEBUFFER]=re),!0):!1}function Ae(D,re){let te=d,pe=!1;if(D){te=u.get(re),te===void 0&&(te=[],u.set(re,te));const J=D.textures;if(te.length!==J.length||te[0]!==i.COLOR_ATTACHMENT0){for(let X=0,_e=J.length;X<_e;X++)te[X]=i.COLOR_ATTACHMENT0+X;te.length=J.length,pe=!0}}else te[0]!==i.BACK&&(te[0]=i.BACK,pe=!0);pe&&i.drawBuffers(te)}function Ce(D){return _!==D?(i.useProgram(D),_=D,!0):!1}const ft={[Fn]:i.FUNC_ADD,[fl]:i.FUNC_SUBTRACT,[dl]:i.FUNC_REVERSE_SUBTRACT};ft[pl]=i.MIN,ft[ml]=i.MAX;const Ge={[gl]:i.ZERO,[_l]:i.ONE,[xl]:i.SRC_COLOR,[rs]:i.SRC_ALPHA,[yl]:i.SRC_ALPHA_SATURATE,[El]:i.DST_COLOR,[Ml]:i.DST_ALPHA,[vl]:i.ONE_MINUS_SRC_COLOR,[ss]:i.ONE_MINUS_SRC_ALPHA,[Tl]:i.ONE_MINUS_DST_COLOR,[Sl]:i.ONE_MINUS_DST_ALPHA,[bl]:i.CONSTANT_COLOR,[Al]:i.ONE_MINUS_CONSTANT_COLOR,[Rl]:i.CONSTANT_ALPHA,[wl]:i.ONE_MINUS_CONSTANT_ALPHA};function Ke(D,re,te,pe,J,X,_e,Pe,nt,Ze){if(D===un){M===!0&&(ae(i.BLEND),M=!1);return}if(M===!1&&(ne(i.BLEND),M=!0),D!==hl){if(D!==p||Ze!==E){if((h!==Fn||y!==Fn)&&(i.blendEquation(i.FUNC_ADD),h=Fn,y=Fn),Ze)switch(D){case bn:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case va:i.blendFunc(i.ONE,i.ONE);break;case Ma:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Sa:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:We("WebGLState: Invalid blending: ",D);break}else switch(D){case bn:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case va:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Ma:We("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Sa:We("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:We("WebGLState: Invalid blending: ",D);break}S=null,b=null,w=null,A=null,P.set(0,0,0),x=0,p=D,E=Ze}return}J=J||re,X=X||te,_e=_e||pe,(re!==h||J!==y)&&(i.blendEquationSeparate(ft[re],ft[J]),h=re,y=J),(te!==S||pe!==b||X!==w||_e!==A)&&(i.blendFuncSeparate(Ge[te],Ge[pe],Ge[X],Ge[_e]),S=te,b=pe,w=X,A=_e),(Pe.equals(P)===!1||nt!==x)&&(i.blendColor(Pe.r,Pe.g,Pe.b,nt),P.copy(Pe),x=nt),p=D,E=!1}function Qe(D,re){D.side===ln?ae(i.CULL_FACE):ne(i.CULL_FACE);let te=D.side===At;re&&(te=!te),Ne(te),D.blending===bn&&D.transparent===!1?Ke(un):Ke(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),a.setFunc(D.depthFunc),a.setTest(D.depthTest),a.setMask(D.depthWrite),s.setMask(D.colorWrite);const pe=D.stencilWrite;o.setTest(pe),pe&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),lt(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?ne(i.SAMPLE_ALPHA_TO_COVERAGE):ae(i.SAMPLE_ALPHA_TO_COVERAGE)}function Ne(D){W!==D&&(D?i.frontFace(i.CW):i.frontFace(i.CCW),W=D)}function st(D){D!==ll?(ne(i.CULL_FACE),D!==R&&(D===xa?i.cullFace(i.BACK):D===cl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ae(i.CULL_FACE),R=D}function C(D){D!==U&&(B&&i.lineWidth(D),U=D)}function lt(D,re,te){D?(ne(i.POLYGON_OFFSET_FILL),(F!==re||z!==te)&&(F=re,z=te,a.getReversed()&&(re=-re),i.polygonOffset(re,te))):ae(i.POLYGON_OFFSET_FILL)}function qe(D){D?ne(i.SCISSOR_TEST):ae(i.SCISSOR_TEST)}function tt(D){D===void 0&&(D=i.TEXTURE0+G-1),$!==D&&(i.activeTexture(D),$=D)}function Me(D,re,te){te===void 0&&($===null?te=i.TEXTURE0+G-1:te=$);let pe=he[te];pe===void 0&&(pe={type:void 0,texture:void 0},he[te]=pe),(pe.type!==D||pe.texture!==re)&&($!==te&&(i.activeTexture(te),$=te),i.bindTexture(D,re||q[D]),pe.type=D,pe.texture=re)}function T(){const D=he[$];D!==void 0&&D.type!==void 0&&(i.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function g(){try{i.compressedTexImage2D(...arguments)}catch(D){We("WebGLState:",D)}}function L(){try{i.compressedTexImage3D(...arguments)}catch(D){We("WebGLState:",D)}}function K(){try{i.texSubImage2D(...arguments)}catch(D){We("WebGLState:",D)}}function Z(){try{i.texSubImage3D(...arguments)}catch(D){We("WebGLState:",D)}}function Y(){try{i.compressedTexSubImage2D(...arguments)}catch(D){We("WebGLState:",D)}}function me(){try{i.compressedTexSubImage3D(...arguments)}catch(D){We("WebGLState:",D)}}function ie(){try{i.texStorage2D(...arguments)}catch(D){We("WebGLState:",D)}}function ye(){try{i.texStorage3D(...arguments)}catch(D){We("WebGLState:",D)}}function Re(){try{i.texImage2D(...arguments)}catch(D){We("WebGLState:",D)}}function j(){try{i.texImage3D(...arguments)}catch(D){We("WebGLState:",D)}}function ee(D){be.equals(D)===!1&&(i.scissor(D.x,D.y,D.z,D.w),be.copy(D))}function ge(D){ze.equals(D)===!1&&(i.viewport(D.x,D.y,D.z,D.w),ze.copy(D))}function xe(D,re){let te=l.get(re);te===void 0&&(te=new WeakMap,l.set(re,te));let pe=te.get(D);pe===void 0&&(pe=i.getUniformBlockIndex(re,D.name),te.set(D,pe))}function fe(D,re){const pe=l.get(re).get(D);c.get(re)!==pe&&(i.uniformBlockBinding(re,pe,D.__bindingPointIndex),c.set(re,pe))}function Fe(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),f={},$=null,he={},m={},u=new WeakMap,d=[],_=null,M=!1,p=null,h=null,S=null,b=null,y=null,w=null,A=null,P=new Ye(0,0,0),x=0,E=!1,W=null,R=null,U=null,F=null,z=null,be.set(0,0,i.canvas.width,i.canvas.height),ze.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:ne,disable:ae,bindFramebuffer:Le,drawBuffers:Ae,useProgram:Ce,setBlending:Ke,setMaterial:Qe,setFlipSided:Ne,setCullFace:st,setLineWidth:C,setPolygonOffset:lt,setScissorTest:qe,activeTexture:tt,bindTexture:Me,unbindTexture:T,compressedTexImage2D:g,compressedTexImage3D:L,texImage2D:Re,texImage3D:j,updateUBOMapping:xe,uniformBlockBinding:fe,texStorage2D:ie,texStorage3D:ye,texSubImage2D:K,texSubImage3D:Z,compressedTexSubImage2D:Y,compressedTexSubImage3D:me,scissor:ee,viewport:ge,reset:Fe}}function up(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Xe,f=new WeakMap;let m;const u=new WeakMap;let d=!1;try{d=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(T,g){return d?new OffscreenCanvas(T,g):dr("canvas")}function M(T,g,L){let K=1;const Z=Me(T);if((Z.width>L||Z.height>L)&&(K=L/Math.max(Z.width,Z.height)),K<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const Y=Math.floor(K*Z.width),me=Math.floor(K*Z.height);m===void 0&&(m=_(Y,me));const ie=g?_(Y,me):m;return ie.width=Y,ie.height=me,ie.getContext("2d").drawImage(T,0,0,Y,me),we("WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+Y+"x"+me+")."),ie}else return"data"in T&&we("WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),T;return T}function p(T){return T.generateMipmaps}function h(T){i.generateMipmap(T)}function S(T){return T.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?i.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function b(T,g,L,K,Z=!1){if(T!==null){if(i[T]!==void 0)return i[T];we("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let Y=g;if(g===i.RED&&(L===i.FLOAT&&(Y=i.R32F),L===i.HALF_FLOAT&&(Y=i.R16F),L===i.UNSIGNED_BYTE&&(Y=i.R8)),g===i.RED_INTEGER&&(L===i.UNSIGNED_BYTE&&(Y=i.R8UI),L===i.UNSIGNED_SHORT&&(Y=i.R16UI),L===i.UNSIGNED_INT&&(Y=i.R32UI),L===i.BYTE&&(Y=i.R8I),L===i.SHORT&&(Y=i.R16I),L===i.INT&&(Y=i.R32I)),g===i.RG&&(L===i.FLOAT&&(Y=i.RG32F),L===i.HALF_FLOAT&&(Y=i.RG16F),L===i.UNSIGNED_BYTE&&(Y=i.RG8)),g===i.RG_INTEGER&&(L===i.UNSIGNED_BYTE&&(Y=i.RG8UI),L===i.UNSIGNED_SHORT&&(Y=i.RG16UI),L===i.UNSIGNED_INT&&(Y=i.RG32UI),L===i.BYTE&&(Y=i.RG8I),L===i.SHORT&&(Y=i.RG16I),L===i.INT&&(Y=i.RG32I)),g===i.RGB_INTEGER&&(L===i.UNSIGNED_BYTE&&(Y=i.RGB8UI),L===i.UNSIGNED_SHORT&&(Y=i.RGB16UI),L===i.UNSIGNED_INT&&(Y=i.RGB32UI),L===i.BYTE&&(Y=i.RGB8I),L===i.SHORT&&(Y=i.RGB16I),L===i.INT&&(Y=i.RGB32I)),g===i.RGBA_INTEGER&&(L===i.UNSIGNED_BYTE&&(Y=i.RGBA8UI),L===i.UNSIGNED_SHORT&&(Y=i.RGBA16UI),L===i.UNSIGNED_INT&&(Y=i.RGBA32UI),L===i.BYTE&&(Y=i.RGBA8I),L===i.SHORT&&(Y=i.RGBA16I),L===i.INT&&(Y=i.RGBA32I)),g===i.RGB&&(L===i.UNSIGNED_INT_5_9_9_9_REV&&(Y=i.RGB9_E5),L===i.UNSIGNED_INT_10F_11F_11F_REV&&(Y=i.R11F_G11F_B10F)),g===i.RGBA){const me=Z?hr:He.getTransfer(K);L===i.FLOAT&&(Y=i.RGBA32F),L===i.HALF_FLOAT&&(Y=i.RGBA16F),L===i.UNSIGNED_BYTE&&(Y=me===$e?i.SRGB8_ALPHA8:i.RGBA8),L===i.UNSIGNED_SHORT_4_4_4_4&&(Y=i.RGBA4),L===i.UNSIGNED_SHORT_5_5_5_1&&(Y=i.RGB5_A1)}return(Y===i.R16F||Y===i.R32F||Y===i.RG16F||Y===i.RG32F||Y===i.RGBA16F||Y===i.RGBA32F)&&e.get("EXT_color_buffer_float"),Y}function y(T,g){let L;return T?g===null||g===Jt||g===Ai?L=i.DEPTH24_STENCIL8:g===Yt?L=i.DEPTH32F_STENCIL8:g===bi&&(L=i.DEPTH24_STENCIL8,we("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===Jt||g===Ai?L=i.DEPTH_COMPONENT24:g===Yt?L=i.DEPTH_COMPONENT32F:g===bi&&(L=i.DEPTH_COMPONENT16),L}function w(T,g){return p(T)===!0||T.isFramebufferTexture&&T.minFilter!==gt&&T.minFilter!==Mt?Math.log2(Math.max(g.width,g.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?g.mipmaps.length:1}function A(T){const g=T.target;g.removeEventListener("dispose",A),x(g),g.isVideoTexture&&f.delete(g)}function P(T){const g=T.target;g.removeEventListener("dispose",P),W(g)}function x(T){const g=n.get(T);if(g.__webglInit===void 0)return;const L=T.source,K=u.get(L);if(K){const Z=K[g.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&E(T),Object.keys(K).length===0&&u.delete(L)}n.remove(T)}function E(T){const g=n.get(T);i.deleteTexture(g.__webglTexture);const L=T.source,K=u.get(L);delete K[g.__cacheKey],a.memory.textures--}function W(T){const g=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let K=0;K<6;K++){if(Array.isArray(g.__webglFramebuffer[K]))for(let Z=0;Z<g.__webglFramebuffer[K].length;Z++)i.deleteFramebuffer(g.__webglFramebuffer[K][Z]);else i.deleteFramebuffer(g.__webglFramebuffer[K]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[K])}else{if(Array.isArray(g.__webglFramebuffer))for(let K=0;K<g.__webglFramebuffer.length;K++)i.deleteFramebuffer(g.__webglFramebuffer[K]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let K=0;K<g.__webglColorRenderbuffer.length;K++)g.__webglColorRenderbuffer[K]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[K]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const L=T.textures;for(let K=0,Z=L.length;K<Z;K++){const Y=n.get(L[K]);Y.__webglTexture&&(i.deleteTexture(Y.__webglTexture),a.memory.textures--),n.remove(L[K])}n.remove(T)}let R=0;function U(){R=0}function F(){const T=R;return T>=r.maxTextures&&we("WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+r.maxTextures),R+=1,T}function z(T){const g=[];return g.push(T.wrapS),g.push(T.wrapT),g.push(T.wrapR||0),g.push(T.magFilter),g.push(T.minFilter),g.push(T.anisotropy),g.push(T.internalFormat),g.push(T.format),g.push(T.type),g.push(T.generateMipmaps),g.push(T.premultiplyAlpha),g.push(T.flipY),g.push(T.unpackAlignment),g.push(T.colorSpace),g.join()}function G(T,g){const L=n.get(T);if(T.isVideoTexture&&qe(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&L.__version!==T.version){const K=T.image;if(K===null)we("WebGLRenderer: Texture marked for update but no image data found.");else if(K.complete===!1)we("WebGLRenderer: Texture marked for update but image is incomplete");else{q(L,T,g);return}}else T.isExternalTexture&&(L.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,L.__webglTexture,i.TEXTURE0+g)}function B(T,g){const L=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&L.__version!==T.version){q(L,T,g);return}else T.isExternalTexture&&(L.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,L.__webglTexture,i.TEXTURE0+g)}function H(T,g){const L=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&L.__version!==T.version){q(L,T,g);return}t.bindTexture(i.TEXTURE_3D,L.__webglTexture,i.TEXTURE0+g)}function Q(T,g){const L=n.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&L.__version!==T.version){ne(L,T,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,L.__webglTexture,i.TEXTURE0+g)}const $={[ds]:i.REPEAT,[cn]:i.CLAMP_TO_EDGE,[ps]:i.MIRRORED_REPEAT},he={[gt]:i.NEAREST,[Dl]:i.NEAREST_MIPMAP_NEAREST,[Ni]:i.NEAREST_MIPMAP_LINEAR,[Mt]:i.LINEAR,[Ar]:i.LINEAR_MIPMAP_NEAREST,[Bn]:i.LINEAR_MIPMAP_LINEAR},oe={[Nl]:i.NEVER,[Vl]:i.ALWAYS,[Fl]:i.LESS,[ia]:i.LEQUAL,[Ol]:i.EQUAL,[ra]:i.GEQUAL,[Bl]:i.GREATER,[zl]:i.NOTEQUAL};function se(T,g){if(g.type===Yt&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===Mt||g.magFilter===Ar||g.magFilter===Ni||g.magFilter===Bn||g.minFilter===Mt||g.minFilter===Ar||g.minFilter===Ni||g.minFilter===Bn)&&we("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(T,i.TEXTURE_WRAP_S,$[g.wrapS]),i.texParameteri(T,i.TEXTURE_WRAP_T,$[g.wrapT]),(T===i.TEXTURE_3D||T===i.TEXTURE_2D_ARRAY)&&i.texParameteri(T,i.TEXTURE_WRAP_R,$[g.wrapR]),i.texParameteri(T,i.TEXTURE_MAG_FILTER,he[g.magFilter]),i.texParameteri(T,i.TEXTURE_MIN_FILTER,he[g.minFilter]),g.compareFunction&&(i.texParameteri(T,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(T,i.TEXTURE_COMPARE_FUNC,oe[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===gt||g.minFilter!==Ni&&g.minFilter!==Bn||g.type===Yt&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){const L=e.get("EXT_texture_filter_anisotropic");i.texParameterf(T,L.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,r.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function be(T,g){let L=!1;T.__webglInit===void 0&&(T.__webglInit=!0,g.addEventListener("dispose",A));const K=g.source;let Z=u.get(K);Z===void 0&&(Z={},u.set(K,Z));const Y=z(g);if(Y!==T.__cacheKey){Z[Y]===void 0&&(Z[Y]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,L=!0),Z[Y].usedTimes++;const me=Z[T.__cacheKey];me!==void 0&&(Z[T.__cacheKey].usedTimes--,me.usedTimes===0&&E(g)),T.__cacheKey=Y,T.__webglTexture=Z[Y].texture}return L}function ze(T,g,L){return Math.floor(Math.floor(T/L)/g)}function Ve(T,g,L,K){const Y=T.updateRanges;if(Y.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,g.width,g.height,L,K,g.data);else{Y.sort((j,ee)=>j.start-ee.start);let me=0;for(let j=1;j<Y.length;j++){const ee=Y[me],ge=Y[j],xe=ee.start+ee.count,fe=ze(ge.start,g.width,4),Fe=ze(ee.start,g.width,4);ge.start<=xe+1&&fe===Fe&&ze(ge.start+ge.count-1,g.width,4)===fe?ee.count=Math.max(ee.count,ge.start+ge.count-ee.start):(++me,Y[me]=ge)}Y.length=me+1;const ie=i.getParameter(i.UNPACK_ROW_LENGTH),ye=i.getParameter(i.UNPACK_SKIP_PIXELS),Re=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,g.width);for(let j=0,ee=Y.length;j<ee;j++){const ge=Y[j],xe=Math.floor(ge.start/4),fe=Math.ceil(ge.count/4),Fe=xe%g.width,D=Math.floor(xe/g.width),re=fe,te=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,Fe),i.pixelStorei(i.UNPACK_SKIP_ROWS,D),t.texSubImage2D(i.TEXTURE_2D,0,Fe,D,re,te,L,K,g.data)}T.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,ie),i.pixelStorei(i.UNPACK_SKIP_PIXELS,ye),i.pixelStorei(i.UNPACK_SKIP_ROWS,Re)}}function q(T,g,L){let K=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(K=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(K=i.TEXTURE_3D);const Z=be(T,g),Y=g.source;t.bindTexture(K,T.__webglTexture,i.TEXTURE0+L);const me=n.get(Y);if(Y.version!==me.__version||Z===!0){t.activeTexture(i.TEXTURE0+L);const ie=He.getPrimaries(He.workingColorSpace),ye=g.colorSpace===Tn?null:He.getPrimaries(g.colorSpace),Re=g.colorSpace===Tn||ie===ye?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Re);let j=M(g.image,!1,r.maxTextureSize);j=tt(g,j);const ee=s.convert(g.format,g.colorSpace),ge=s.convert(g.type);let xe=b(g.internalFormat,ee,ge,g.colorSpace,g.isVideoTexture);se(K,g);let fe;const Fe=g.mipmaps,D=g.isVideoTexture!==!0,re=me.__version===void 0||Z===!0,te=Y.dataReady,pe=w(g,j);if(g.isDepthTexture)xe=y(g.format===zn,g.type),re&&(D?t.texStorage2D(i.TEXTURE_2D,1,xe,j.width,j.height):t.texImage2D(i.TEXTURE_2D,0,xe,j.width,j.height,0,ee,ge,null));else if(g.isDataTexture)if(Fe.length>0){D&&re&&t.texStorage2D(i.TEXTURE_2D,pe,xe,Fe[0].width,Fe[0].height);for(let J=0,X=Fe.length;J<X;J++)fe=Fe[J],D?te&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,fe.width,fe.height,ee,ge,fe.data):t.texImage2D(i.TEXTURE_2D,J,xe,fe.width,fe.height,0,ee,ge,fe.data);g.generateMipmaps=!1}else D?(re&&t.texStorage2D(i.TEXTURE_2D,pe,xe,j.width,j.height),te&&Ve(g,j,ee,ge)):t.texImage2D(i.TEXTURE_2D,0,xe,j.width,j.height,0,ee,ge,j.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){D&&re&&t.texStorage3D(i.TEXTURE_2D_ARRAY,pe,xe,Fe[0].width,Fe[0].height,j.depth);for(let J=0,X=Fe.length;J<X;J++)if(fe=Fe[J],g.format!==Ht)if(ee!==null)if(D){if(te)if(g.layerUpdates.size>0){const _e=qa(fe.width,fe.height,g.format,g.type);for(const Pe of g.layerUpdates){const nt=fe.data.subarray(Pe*_e/fe.data.BYTES_PER_ELEMENT,(Pe+1)*_e/fe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,Pe,fe.width,fe.height,1,ee,nt)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,fe.width,fe.height,j.depth,ee,fe.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,J,xe,fe.width,fe.height,j.depth,0,fe.data,0,0);else we("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else D?te&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,fe.width,fe.height,j.depth,ee,ge,fe.data):t.texImage3D(i.TEXTURE_2D_ARRAY,J,xe,fe.width,fe.height,j.depth,0,ee,ge,fe.data)}else{D&&re&&t.texStorage2D(i.TEXTURE_2D,pe,xe,Fe[0].width,Fe[0].height);for(let J=0,X=Fe.length;J<X;J++)fe=Fe[J],g.format!==Ht?ee!==null?D?te&&t.compressedTexSubImage2D(i.TEXTURE_2D,J,0,0,fe.width,fe.height,ee,fe.data):t.compressedTexImage2D(i.TEXTURE_2D,J,xe,fe.width,fe.height,0,fe.data):we("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):D?te&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,fe.width,fe.height,ee,ge,fe.data):t.texImage2D(i.TEXTURE_2D,J,xe,fe.width,fe.height,0,ee,ge,fe.data)}else if(g.isDataArrayTexture)if(D){if(re&&t.texStorage3D(i.TEXTURE_2D_ARRAY,pe,xe,j.width,j.height,j.depth),te)if(g.layerUpdates.size>0){const J=qa(j.width,j.height,g.format,g.type);for(const X of g.layerUpdates){const _e=j.data.subarray(X*J/j.data.BYTES_PER_ELEMENT,(X+1)*J/j.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,X,j.width,j.height,1,ee,ge,_e)}g.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,j.width,j.height,j.depth,ee,ge,j.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,xe,j.width,j.height,j.depth,0,ee,ge,j.data);else if(g.isData3DTexture)D?(re&&t.texStorage3D(i.TEXTURE_3D,pe,xe,j.width,j.height,j.depth),te&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,j.width,j.height,j.depth,ee,ge,j.data)):t.texImage3D(i.TEXTURE_3D,0,xe,j.width,j.height,j.depth,0,ee,ge,j.data);else if(g.isFramebufferTexture){if(re)if(D)t.texStorage2D(i.TEXTURE_2D,pe,xe,j.width,j.height);else{let J=j.width,X=j.height;for(let _e=0;_e<pe;_e++)t.texImage2D(i.TEXTURE_2D,_e,xe,J,X,0,ee,ge,null),J>>=1,X>>=1}}else if(Fe.length>0){if(D&&re){const J=Me(Fe[0]);t.texStorage2D(i.TEXTURE_2D,pe,xe,J.width,J.height)}for(let J=0,X=Fe.length;J<X;J++)fe=Fe[J],D?te&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,ee,ge,fe):t.texImage2D(i.TEXTURE_2D,J,xe,ee,ge,fe);g.generateMipmaps=!1}else if(D){if(re){const J=Me(j);t.texStorage2D(i.TEXTURE_2D,pe,xe,J.width,J.height)}te&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ee,ge,j)}else t.texImage2D(i.TEXTURE_2D,0,xe,ee,ge,j);p(g)&&h(K),me.__version=Y.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function ne(T,g,L){if(g.image.length!==6)return;const K=be(T,g),Z=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,T.__webglTexture,i.TEXTURE0+L);const Y=n.get(Z);if(Z.version!==Y.__version||K===!0){t.activeTexture(i.TEXTURE0+L);const me=He.getPrimaries(He.workingColorSpace),ie=g.colorSpace===Tn?null:He.getPrimaries(g.colorSpace),ye=g.colorSpace===Tn||me===ie?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ye);const Re=g.isCompressedTexture||g.image[0].isCompressedTexture,j=g.image[0]&&g.image[0].isDataTexture,ee=[];for(let X=0;X<6;X++)!Re&&!j?ee[X]=M(g.image[X],!0,r.maxCubemapSize):ee[X]=j?g.image[X].image:g.image[X],ee[X]=tt(g,ee[X]);const ge=ee[0],xe=s.convert(g.format,g.colorSpace),fe=s.convert(g.type),Fe=b(g.internalFormat,xe,fe,g.colorSpace),D=g.isVideoTexture!==!0,re=Y.__version===void 0||K===!0,te=Z.dataReady;let pe=w(g,ge);se(i.TEXTURE_CUBE_MAP,g);let J;if(Re){D&&re&&t.texStorage2D(i.TEXTURE_CUBE_MAP,pe,Fe,ge.width,ge.height);for(let X=0;X<6;X++){J=ee[X].mipmaps;for(let _e=0;_e<J.length;_e++){const Pe=J[_e];g.format!==Ht?xe!==null?D?te&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,_e,0,0,Pe.width,Pe.height,xe,Pe.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,_e,Fe,Pe.width,Pe.height,0,Pe.data):we("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):D?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,_e,0,0,Pe.width,Pe.height,xe,fe,Pe.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,_e,Fe,Pe.width,Pe.height,0,xe,fe,Pe.data)}}}else{if(J=g.mipmaps,D&&re){J.length>0&&pe++;const X=Me(ee[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,pe,Fe,X.width,X.height)}for(let X=0;X<6;X++)if(j){D?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,0,0,ee[X].width,ee[X].height,xe,fe,ee[X].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,Fe,ee[X].width,ee[X].height,0,xe,fe,ee[X].data);for(let _e=0;_e<J.length;_e++){const nt=J[_e].image[X].image;D?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,_e+1,0,0,nt.width,nt.height,xe,fe,nt.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,_e+1,Fe,nt.width,nt.height,0,xe,fe,nt.data)}}else{D?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,0,0,xe,fe,ee[X]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,Fe,xe,fe,ee[X]);for(let _e=0;_e<J.length;_e++){const Pe=J[_e];D?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,_e+1,0,0,xe,fe,Pe.image[X]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,_e+1,Fe,xe,fe,Pe.image[X])}}}p(g)&&h(i.TEXTURE_CUBE_MAP),Y.__version=Z.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function ae(T,g,L,K,Z,Y){const me=s.convert(L.format,L.colorSpace),ie=s.convert(L.type),ye=b(L.internalFormat,me,ie,L.colorSpace),Re=n.get(g),j=n.get(L);if(j.__renderTarget=g,!Re.__hasExternalTextures){const ee=Math.max(1,g.width>>Y),ge=Math.max(1,g.height>>Y);Z===i.TEXTURE_3D||Z===i.TEXTURE_2D_ARRAY?t.texImage3D(Z,Y,ye,ee,ge,g.depth,0,me,ie,null):t.texImage2D(Z,Y,ye,ee,ge,0,me,ie,null)}t.bindFramebuffer(i.FRAMEBUFFER,T),lt(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,K,Z,j.__webglTexture,0,C(g)):(Z===i.TEXTURE_2D||Z>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,K,Z,j.__webglTexture,Y),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Le(T,g,L){if(i.bindRenderbuffer(i.RENDERBUFFER,T),g.depthBuffer){const K=g.depthTexture,Z=K&&K.isDepthTexture?K.type:null,Y=y(g.stencilBuffer,Z),me=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;lt(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,C(g),Y,g.width,g.height):L?i.renderbufferStorageMultisample(i.RENDERBUFFER,C(g),Y,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,Y,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,me,i.RENDERBUFFER,T)}else{const K=g.textures;for(let Z=0;Z<K.length;Z++){const Y=K[Z],me=s.convert(Y.format,Y.colorSpace),ie=s.convert(Y.type),ye=b(Y.internalFormat,me,ie,Y.colorSpace);lt(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,C(g),ye,g.width,g.height):L?i.renderbufferStorageMultisample(i.RENDERBUFFER,C(g),ye,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,ye,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Ae(T,g,L){const K=g.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,T),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Z=n.get(g.depthTexture);if(Z.__renderTarget=g,(!Z.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),K){if(Z.__webglInit===void 0&&(Z.__webglInit=!0,g.depthTexture.addEventListener("dispose",A)),Z.__webglTexture===void 0){Z.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,Z.__webglTexture),se(i.TEXTURE_CUBE_MAP,g.depthTexture);const Re=s.convert(g.depthTexture.format),j=s.convert(g.depthTexture.type);let ee;g.depthTexture.format===dn?ee=i.DEPTH_COMPONENT24:g.depthTexture.format===zn&&(ee=i.DEPTH24_STENCIL8);for(let ge=0;ge<6;ge++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,ee,g.width,g.height,0,Re,j,null)}}else G(g.depthTexture,0);const Y=Z.__webglTexture,me=C(g),ie=K?i.TEXTURE_CUBE_MAP_POSITIVE_X+L:i.TEXTURE_2D,ye=g.depthTexture.format===zn?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(g.depthTexture.format===dn)lt(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ye,ie,Y,0,me):i.framebufferTexture2D(i.FRAMEBUFFER,ye,ie,Y,0);else if(g.depthTexture.format===zn)lt(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ye,ie,Y,0,me):i.framebufferTexture2D(i.FRAMEBUFFER,ye,ie,Y,0);else throw new Error("Unknown depthTexture format")}function Ce(T){const g=n.get(T),L=T.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==T.depthTexture){const K=T.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),K){const Z=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,K.removeEventListener("dispose",Z)};K.addEventListener("dispose",Z),g.__depthDisposeCallback=Z}g.__boundDepthTexture=K}if(T.depthTexture&&!g.__autoAllocateDepthBuffer)if(L)for(let K=0;K<6;K++)Ae(g.__webglFramebuffer[K],T,K);else{const K=T.texture.mipmaps;K&&K.length>0?Ae(g.__webglFramebuffer[0],T,0):Ae(g.__webglFramebuffer,T,0)}else if(L){g.__webglDepthbuffer=[];for(let K=0;K<6;K++)if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[K]),g.__webglDepthbuffer[K]===void 0)g.__webglDepthbuffer[K]=i.createRenderbuffer(),Le(g.__webglDepthbuffer[K],T,!1);else{const Z=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Y=g.__webglDepthbuffer[K];i.bindRenderbuffer(i.RENDERBUFFER,Y),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,Y)}}else{const K=T.texture.mipmaps;if(K&&K.length>0?t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),Le(g.__webglDepthbuffer,T,!1);else{const Z=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Y=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,Y),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,Y)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function ft(T,g,L){const K=n.get(T);g!==void 0&&ae(K.__webglFramebuffer,T,T.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),L!==void 0&&Ce(T)}function Ge(T){const g=T.texture,L=n.get(T),K=n.get(g);T.addEventListener("dispose",P);const Z=T.textures,Y=T.isWebGLCubeRenderTarget===!0,me=Z.length>1;if(me||(K.__webglTexture===void 0&&(K.__webglTexture=i.createTexture()),K.__version=g.version,a.memory.textures++),Y){L.__webglFramebuffer=[];for(let ie=0;ie<6;ie++)if(g.mipmaps&&g.mipmaps.length>0){L.__webglFramebuffer[ie]=[];for(let ye=0;ye<g.mipmaps.length;ye++)L.__webglFramebuffer[ie][ye]=i.createFramebuffer()}else L.__webglFramebuffer[ie]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){L.__webglFramebuffer=[];for(let ie=0;ie<g.mipmaps.length;ie++)L.__webglFramebuffer[ie]=i.createFramebuffer()}else L.__webglFramebuffer=i.createFramebuffer();if(me)for(let ie=0,ye=Z.length;ie<ye;ie++){const Re=n.get(Z[ie]);Re.__webglTexture===void 0&&(Re.__webglTexture=i.createTexture(),a.memory.textures++)}if(T.samples>0&&lt(T)===!1){L.__webglMultisampledFramebuffer=i.createFramebuffer(),L.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,L.__webglMultisampledFramebuffer);for(let ie=0;ie<Z.length;ie++){const ye=Z[ie];L.__webglColorRenderbuffer[ie]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,L.__webglColorRenderbuffer[ie]);const Re=s.convert(ye.format,ye.colorSpace),j=s.convert(ye.type),ee=b(ye.internalFormat,Re,j,ye.colorSpace,T.isXRRenderTarget===!0),ge=C(T);i.renderbufferStorageMultisample(i.RENDERBUFFER,ge,ee,T.width,T.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ie,i.RENDERBUFFER,L.__webglColorRenderbuffer[ie])}i.bindRenderbuffer(i.RENDERBUFFER,null),T.depthBuffer&&(L.__webglDepthRenderbuffer=i.createRenderbuffer(),Le(L.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(Y){t.bindTexture(i.TEXTURE_CUBE_MAP,K.__webglTexture),se(i.TEXTURE_CUBE_MAP,g);for(let ie=0;ie<6;ie++)if(g.mipmaps&&g.mipmaps.length>0)for(let ye=0;ye<g.mipmaps.length;ye++)ae(L.__webglFramebuffer[ie][ye],T,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,ye);else ae(L.__webglFramebuffer[ie],T,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0);p(g)&&h(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(me){for(let ie=0,ye=Z.length;ie<ye;ie++){const Re=Z[ie],j=n.get(Re);let ee=i.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(ee=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ee,j.__webglTexture),se(ee,Re),ae(L.__webglFramebuffer,T,Re,i.COLOR_ATTACHMENT0+ie,ee,0),p(Re)&&h(ee)}t.unbindTexture()}else{let ie=i.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(ie=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ie,K.__webglTexture),se(ie,g),g.mipmaps&&g.mipmaps.length>0)for(let ye=0;ye<g.mipmaps.length;ye++)ae(L.__webglFramebuffer[ye],T,g,i.COLOR_ATTACHMENT0,ie,ye);else ae(L.__webglFramebuffer,T,g,i.COLOR_ATTACHMENT0,ie,0);p(g)&&h(ie),t.unbindTexture()}T.depthBuffer&&Ce(T)}function Ke(T){const g=T.textures;for(let L=0,K=g.length;L<K;L++){const Z=g[L];if(p(Z)){const Y=S(T),me=n.get(Z).__webglTexture;t.bindTexture(Y,me),h(Y),t.unbindTexture()}}}const Qe=[],Ne=[];function st(T){if(T.samples>0){if(lt(T)===!1){const g=T.textures,L=T.width,K=T.height;let Z=i.COLOR_BUFFER_BIT;const Y=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,me=n.get(T),ie=g.length>1;if(ie)for(let Re=0;Re<g.length;Re++)t.bindFramebuffer(i.FRAMEBUFFER,me.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Re,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,me.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Re,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,me.__webglMultisampledFramebuffer);const ye=T.texture.mipmaps;ye&&ye.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,me.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,me.__webglFramebuffer);for(let Re=0;Re<g.length;Re++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(Z|=i.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(Z|=i.STENCIL_BUFFER_BIT)),ie){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,me.__webglColorRenderbuffer[Re]);const j=n.get(g[Re]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,j,0)}i.blitFramebuffer(0,0,L,K,0,0,L,K,Z,i.NEAREST),c===!0&&(Qe.length=0,Ne.length=0,Qe.push(i.COLOR_ATTACHMENT0+Re),T.depthBuffer&&T.resolveDepthBuffer===!1&&(Qe.push(Y),Ne.push(Y),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Ne)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Qe))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ie)for(let Re=0;Re<g.length;Re++){t.bindFramebuffer(i.FRAMEBUFFER,me.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Re,i.RENDERBUFFER,me.__webglColorRenderbuffer[Re]);const j=n.get(g[Re]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,me.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Re,i.TEXTURE_2D,j,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,me.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&c){const g=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function C(T){return Math.min(r.maxSamples,T.samples)}function lt(T){const g=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function qe(T){const g=a.render.frame;f.get(T)!==g&&(f.set(T,g),T.update())}function tt(T,g){const L=T.colorSpace,K=T.format,Z=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||L!==ci&&L!==Tn&&(He.getTransfer(L)===$e?(K!==Ht||Z!==Ft)&&we("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):We("WebGLTextures: Unsupported texture color space:",L)),g}function Me(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(l.width=T.naturalWidth||T.width,l.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(l.width=T.displayWidth,l.height=T.displayHeight):(l.width=T.width,l.height=T.height),l}this.allocateTextureUnit=F,this.resetTextureUnits=U,this.setTexture2D=G,this.setTexture2DArray=B,this.setTexture3D=H,this.setTextureCube=Q,this.rebindTextures=ft,this.setupRenderTarget=Ge,this.updateRenderTargetMipmap=Ke,this.updateMultisampleRenderTarget=st,this.setupDepthRenderbuffer=Ce,this.setupFrameBufferTexture=ae,this.useMultisampledRTT=lt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function hp(i,e){function t(n,r=Tn){let s;const a=He.getTransfer(r);if(n===Ft)return i.UNSIGNED_BYTE;if(n===Js)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Qs)return i.UNSIGNED_SHORT_5_5_5_1;if(n===wo)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Co)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Ao)return i.BYTE;if(n===Ro)return i.SHORT;if(n===bi)return i.UNSIGNED_SHORT;if(n===js)return i.INT;if(n===Jt)return i.UNSIGNED_INT;if(n===Yt)return i.FLOAT;if(n===fn)return i.HALF_FLOAT;if(n===Po)return i.ALPHA;if(n===Do)return i.RGB;if(n===Ht)return i.RGBA;if(n===dn)return i.DEPTH_COMPONENT;if(n===zn)return i.DEPTH_STENCIL;if(n===Lo)return i.RED;if(n===ea)return i.RED_INTEGER;if(n===li)return i.RG;if(n===ta)return i.RG_INTEGER;if(n===na)return i.RGBA_INTEGER;if(n===ar||n===or||n===lr||n===cr)if(a===$e)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===ar)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===or)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===lr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===cr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===ar)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===or)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===lr)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===cr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===ms||n===gs||n===_s||n===xs)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===ms)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===gs)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===_s)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===xs)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===vs||n===Ms||n===Ss||n===Es||n===Ts||n===ys||n===bs)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===vs||n===Ms)return a===$e?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Ss)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===Es)return s.COMPRESSED_R11_EAC;if(n===Ts)return s.COMPRESSED_SIGNED_R11_EAC;if(n===ys)return s.COMPRESSED_RG11_EAC;if(n===bs)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===As||n===Rs||n===ws||n===Cs||n===Ps||n===Ds||n===Ls||n===Is||n===Us||n===Ns||n===Fs||n===Os||n===Bs||n===zs)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===As)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Rs)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ws)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Cs)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Ps)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Ds)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Ls)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Is)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Us)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Ns)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Fs)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Os)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Bs)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===zs)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Vs||n===Gs||n===Hs)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===Vs)return a===$e?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Gs)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Hs)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===ks||n===Ws||n===Xs||n===qs)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===ks)return s.COMPRESSED_RED_RGTC1_EXT;if(n===Ws)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Xs)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===qs)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ai?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const fp=`
void main() {
