  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-x-6 gap-y-12">
      ...
      <div className="col-span-1 md:col-span-3 md:pl-6 border-l border-foreground/10 hidden md:flex md:items-center">
        <p className="text-xs font-mono uppercase text-foreground/60">
          Will Provancher
        </p>
      </div>
      ...
      {/* Body */}
      <div className="col-span-1 md:col-span-9">
        <p className="text-base leading-7 font-light text-foreground/80 text-pretty mb-4">
...
<div className="col-span-1 md:col-span-12 grid grid-cols-1 md:grid-cols-3 gap-6">
  ...
  <div className="flex flex-col gap-3 group">
    <div className="h-48 w-full bg-foreground/[0.02] border border-foreground/10 flex items-center justify-center relative overflow-hidden">
      ...
      <svg viewBox="0 0 80 60" className="h-1/2 text-foreground opacity-80 group-hover:opacity-100 transition-opacity duration-500">
        {/* Y 坐标整体下移 10 (例如原来的 20 变成 30, 10 变成 20) */}
    ...
    <div>
      <h4 className="font-mono text-[10px] uppercase tracking-wider text-foreground/50 mb-1">Hypothesis 01</h4>
      <h3 className="text-sm font-medium text-foreground">Versatile Information</h3>
  ...
  <div className="flex flex-col gap-3 group">
    ...
    <div>
      <h4 className="font-mono text-[10px] uppercase tracking-wider text-foreground/50 mb-1">Hypothesis 02</h4>
      <h3 className="text-sm font-medium text-foreground">Sense of Reassurance</h3>
      <p className="text-xs text-foreground/70 mt-1 leading-relaxed">
  ...
  <div className="flex flex-col gap-3 group">
    ...
    <div>
      <h4 className="font-mono text-[10px] uppercase tracking-wider text-foreground/50 mb-1">Hypothesis 03</h4>
      <h3 className="text-sm font-medium text-foreground">Moments of Delight</h3>
      <p className="text-xs text-foreground/70 mt-1 leading-relaxed">
      ...
      <div className="col-span-1 md:col-span-12 flex gap-6 items-start">
        {/* Left: outer border container, two fixed-height images */}
        ...
        {/* Right: self-stretch to match left height, image fills via flex-1 */}
      ...
      {/* ── 05 Special Thanks ─────────────────────────── */}
      <div className="col-span-1 md:col-span-12 border-t border-foreground/10 pt-6">
        <span className="text-xs font-mono uppercase tracking-widest text-foreground/40">
          05 — Special Thanks
        </span>
      </div>
